...
def ChaosAbreCam(per):
	...
	if ChaosKnightMap == 12: # :NOTE: Btomb_back
		AbreCam.PTS.append((per.Position[0]-5000,per.Position[1]-4500, per.Position[2]+1000),per.Position,14)
	elif ChaosKnightMap == 13: # :NOTE: Desert_back
		AbreCam.PTS.append((per.Position[0]-3000,per.Position[1]-2000, per.Position[2]-5500),per.Position,14)
	#AbreCam.PTS.append((per.Position[0]+3000,per.Position[1]-1000, per.Position[2]+3000),per.Position,3.5) # :NOTE: useless
	#AbreCam.PTS.append((per.Position[0]+3000,per.Position[1]-1000, per.Position[2]-3000),per.Position,3.5) # :NOTE: useless
	#AbreCam.PTS.append((per.Position[0]-3000,per.Position[1]-1000, per.Position[2]-3000),per.Position,3.5) # :NOTE: useless
	#AbreCam.LastTime = 0.01 # :NOTE: We can't skip
