...
class B_SpinWidget(BUIx.B_FrameWidget):
  def __init__(self,Parent,Name,Width,Height,font_server,font,default_value):
    ...
    self.AddWidget(self.DefaultText,offset,0.5,BUIx.B_FrameWidget.B_FR_AbsoluteRight,BUIx.B_FrameWidget.B_FR_Right,
                                   BUIx.B_FrameWidget.B_FR_VRelative,BUIx.B_FrameWidget.B_FR_VCenter)


    self.Spin=B_SpinWidgetAux(self,"SpinText "+Name,size,Width,font_server,font) # 50 a ojo (Estoy hasta los c######).
