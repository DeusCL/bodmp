...
if netgame.GetNetState() == 0:
    ...
    def Draw(self,x,y,time):
      ...
      for j in range(self.inv.nKeys):
        ...
        if key.Data==None:
          ...
          key.Data.Used = 1
        if key.Data.Used>0:
          #Bladex.DrawBOD(key.Kind,x+8,y+i*16+16,0,0,self.Scale,1) #:NOTE: Wasn't used ?
  ...
  class B_InvTabletWidget(BUIx.B_TextWidget):
    def __init__(self,Parent,Name,Text,char,tbidx):
      #pdb.set_trace
      BUIx.B_TextWidget.__init__(self,Parent,Name,Text,font_server,"../../Data/Icons/Iconosrunas.fnt");
      self.SetScale(0.15)
      self.SetChar(char)
      self.SetAlpha(1.0)
