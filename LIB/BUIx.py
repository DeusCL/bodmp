...
class B_RectWidgetPtr(B_WidgetPtr):
    ...
    def GetWidget_Idx(self,arg0):
        val = BUIxc.B_RectWidget_GetWidget_Idx(self.this, arg0)
        return val
    def __repr__(self):
...
class B_GridWidgetPtr(B_RectWidgetPtr):
    ...
    def AddWidget(self,arg0,arg1,arg2,arg3,arg4,arg5,arg6):
        val = BUIxc.B_GridWidget_AddWidget(self.this,arg0.this,arg1,arg2,arg3,arg4,arg5,arg6)
        return val
...
class B_TextWidgetPtr(B_RectWidgetPtr):
    ...
    def GetJustification(self):
        ...
        return val
    def SetMaximumWidth(self,arg0):
        val = BUIxc.B_TextWidget_SetMaximumWidth(self.this,arg0)
        return val
    def __str__(self):
...
class B_TextWidgetNoFocus(B_TextWidgetPtr):
    def __init__(self,arg0,arg1,arg2,arg3,arg4,*args) :
        self.this = apply(BUIxc.new_B_TextWidget,(arg0.this,arg1,arg2,arg3.this,arg4,)+args)
        self.thisown = 1
    def AcceptsFocus(self):
