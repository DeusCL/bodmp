...
def CreateWidgetAreYouSure():
    ...
    SelectCharacterWidget.SetText(MenuText.GetMenuText("CHARACTER_SELECTION"))
    ...
    if YesNoActivated:
        ...
        if ScreenSelectionFinished:
            ...
            if YesNoValue:
                ...
                File = open("../../Save/2dMapData.txt","w")
                if CurrentPerson == 0:
                    File.write("AM")
                if CurrentPerson == 1:
                    File.write("BR")
...
def RedefineKeys():
	...
	Bladex.AssocKey("Selecciona","Gamepad","ButtonActionValidate")
...
def ElUsuarioPresionaLaTeclaEscape(Salio):
    print "ElUsuarioPresionaLaTeclaEscape"
