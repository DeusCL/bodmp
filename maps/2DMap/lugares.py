...
AsianLanguages = ["Chinese", "Korean", "Japanese"]
...
if Language.Current in AsianLanguages:
...
def RedefineKeys():
	...
	InputManager.AddInputActionsSet("MapSelection")
	InputManager.SetInputActionsSet("MapSelection")
	...
	Bladex.AssocKey("Next"	,"Gamepad","ButtonRight")
	Bladex.AssocKey("Prev"	,"Gamepad","ButtonLeft")
	Bladex.AssocKey("Select","Gamepad","ButtonActionValidate")
	Bladex.AssocKey("Cancelar","Gamepad","ButtonActionBack")
	Bladex.AssocKey("Cancelar","Gamepad","ButtonStart")
