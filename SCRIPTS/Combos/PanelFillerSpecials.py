...
SpecialsCombosAmz = ["${AttackIcon:Attack}${Left} ${PlusIcon} ${Down:DownRight}${Right:""}", "${AttackIcon:Attack} ${PlusIcon} ${Left:UpLeft}${Up:""}", "${AttackIcon:Attack}${Up} ${PlusIcon} ${Down:ignore}${Up:ignore}${ignore:Turn Around}", "${AttackIcon:Attack} ${PlusIcon} ${Up:UpRight}${Right:""}", "${AttackIcon:Attack} ${PlusIcon} ${Down}"]
SpecialsCombos2Amz = [-1, -1, -1, -1, "${AttackIcon:Attack} ${PlusIcon} ${AttackIcon:Attack}${Up}"]
SpecialsCombosBarb = ["${AttackIcon:Attack}${Left} ${PlusIcon} ${Down:DownRight}${Right:""}", "${AttackIcon:Attack} ${PlusIcon} ${Up} ${PlusIcon} ${Down}", "${AttackIcon:Attack} ${PlusIcon} ${Left:DownLeft}${Down:""}", "${AttackIcon:Attack} ${PlusIcon} ${Down}"]
...
SpecialsCombosDwarf = ["${AttackIcon:Attack}${Left} ${PlusIcon} ${Down:DownRight}${Right:""}", "${AttackIcon:Attack} ${PlusIcon} ${Down:DownRight}${Right:""}", "${AttackIcon:Attack}${Down} ${PlusIcon} ${Down:ignore}${Up:ignore}${ignore:Turn Around}", "${AttackIcon:Attack} ${PlusIcon} ${Left:ignore}${Right:ignore}${ignore:UseAndLeftRight} ${PlusIcon} ${Down:ignore}${Up:ignore}${ignore:Turn Around}", "${AttackIcon:Attack} ${PlusIcon} ${Down}"]
SpecialsCombos2Dwarf = [-1, -1, -1, -1, "${AttackIcon:Attack} ${PlusIcon} ${AttackIcon:Attack}${Up}"]
SpecialsCombosKgt = ["${AttackIcon:Attack}${Left} ${PlusIcon} ${Down:DownRight}${Right:""}", "${AttackIcon:Attack} ${PlusIcon} ${Down:ignore}${Up:ignore}${ignore:Turn Around} ${PlusIcon} ${Down}", "${AttackIcon:Attack} ${PlusIcon} ${Down:ignore}${Up:ignore}${ignore:Turn Around} ${PlusIcon} ${Left:ignore}${Right:ignore}${ignore:UseAndLeftRight}", "${AttackIcon:Attack} ${PlusIcon} ${Down}"]
