...
def Dwf1WhenFirst():	
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "DwarfIcon1")	
...
def Dwf2WhenFirst():	
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "DwarfIcon2")	
...
def TraitorKnightWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "TraitorIcon")	
...
def OrkWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "OrcIcon")	
...
def Dark_OrkWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "OrkDarkIcon")	
...
def Great_OrkWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "GorkIcon")	
...
def LittleDemonWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "LDemonIcon")	
...
def GreaterDemonWhenFirst():
	...
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "GDemonIcon")	
...
def SkeletonWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "SkeletonIcon")	
...
def CosWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "CosIcon")	
...
def MinWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "MinotaurIcon")	
...
def LichWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "Lich")	
...
def SalamanderWhenFirst():	
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "SalamanderIcon")	
...
def ChaosKnightWhenFirst():
	...
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "ChaosIcon")	
...
def VampWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "VampireIcon")	
...
def RagnarWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "RagnarIcon")	
...
def Prs_1WhenFirst():
	...
	if dir(DefAnims).count("Prs_1"):
		DefAnims.Prs_1()
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "PrisonerIcon")	
...
def Knight_ZombieWhenFirst():                           
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "KnightzombieIcon")	
...
def Dark_KnightWhenFirst():                                
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "KnightDarkIcon")	
...
def Troll_DarkWhenFirst():                           
	...
	if dir(DefAnims).count("Trl"):
		DefAnims.Trl()
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "TrollIcon")	
...
def SpidersmallWhenFirst():                           
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "SpiderIcon")	
...
def DalGurakWhenFirst():
	...
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "DalGurakIcon")	
...
def AnAhkardWhenFirst():
	...
	Bladex.AddFloorCTolerance("slip",10)
	import BBLib
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "DarkLordIcon")	
...
def Golem_stoneWhenFirst():
	...
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "StoneGolemIcon")	
...
def Golem_clayWhenFirst():
	...
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "ClayGolemIcon")	
...
def Golem_lavaWhenFirst():
	...
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "LavaGolemIcon")
...
def Golem_metalWhenFirst():
	...
	BBLib.LoadResourceToMemory(BBLib.B_CID_IMAGEFILE, "MetalGolemIcon")	
