...
Bladex.AddInputAction("RotateOrMoveX",0)
Bladex.AddInputAction("RotateOrMoveY",0)
...
Bladex.AssocKey("RotateOrMoveX","Gamepad","X_LAxis")
Bladex.AssocKey("RotateOrMoveY","Gamepad","Y_LAxis")
